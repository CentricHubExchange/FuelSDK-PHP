...
try {	
	...
	$getOrganization->props = array("ID", "Client.ID", "Name", "AccountType", "AccountUsers", "Address", "BrandID", "BusinessName", "Children", "City", "Country", "DeletedDate", "EditionID", "Email", "Fax", "FromName", "InheritAddress", "IsActive", "IsTestAccount", "IsTrialAccount", "LanguageLocale", "Locale", "OrgID", "ParentAccount.ID", "ParentID", "ParentName", "Phone", "PrivateLabelID", "PrivateLabels", "Roles", "State", "TimeZone", "Zip", "CreatedDate", "ModifiedDate", "Client.ModifiedBy", "ObjectID", "CustomerKey", "Client.EnterpriseID", "Client.CreatedBy");
	...
	$postOrganization->props = array("CustomerKey" =>  $CustomerKeyOfTestOrganization, "Name" => $NameOfTestOrganization, "Email" => "test@organization.com", "FromName" => "AGENCY CLIENT", "Business Name" => "Test Organization", "Address" => "123 ABC Street", "City" => "Indianapolis", "State" => "IN", "Zip" => "46202", "IsTestAccount" => true, "EditionID" => 3, "IsActive" => true);
	...
	$patchOrganization->props = array("CustomerKey" => $CustomerKeyOfTestOrganization, "Name" => "New TestOrganizationName");
	...
	$deleteOrganization->props = array("CustomerKey" => $CustomerKeyOfTestOrganization);
